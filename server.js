...
// CORS abierto (tu HTML puede hacer fetch desde cualquier dominio)
...
// Snapshot en memoria (suficiente para empezar)
let snapshot = {
  core_version: "3.1",
...
// GET: devuelve snapshot
app.get("/", (_req, res) => res.json(snapshot));

// POST: guarda snapshot completo
app.post("/", (req, res) => {
